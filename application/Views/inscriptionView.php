...
<form class="needs-validation" id="inscriptionForm" action="/home/show"novalidate>
    ...
    <div class="form-group">
        ...
        <div class="invalid-feedback">
            Veuillez remplir ce champ (3 caractères minimum et 16 maximum).
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="invalid-feedback">
            Veuillez remplir ce champ (vous devez utiliser au minimum une lettre, un chiffre et un symbole).
        </div>
    </div>
    <div class="form-group">
